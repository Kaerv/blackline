<div class="tab-pane fade{if !$product.description} in active{/if}"
     ...
     role="tabpanel"
  >
  <div class="product-description">{$product.description|escape:'htmlall'|nl2br nofilter}</div>
  ...
  {block name='product_features'}
    {if $product.grouped_features}
      <section class="product-features">
        <p class="h6" style="display:none">{l s='Data sheet' d='Shop.Theme.Catalog'}</p>
        <dl class="data-sheet">
